...
export const MODULES = [
  { id: 'retaliation', title: 'Модуль «Возмездие»', description: 'Добавляет каждой грани +1 энергоячейку. Грани копят заряд от попаданий, а способность выпускает самонаводящиеся пули.', price: 180 },
